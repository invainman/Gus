package test.webApp.Gus.service.serviceImpl;

import jakarta.transaction.Transactional;
import lombok.AllArgsConstructor;
import org.springframework.security.crypto.password.PasswordEncoder;
import org.springframework.stereotype.Service;
import test.webApp.Gus.exception.UserAlreadyExistsException;
import test.webApp.Gus.exception.UserNotFoundException;
import test.webApp.Gus.entity.User;
import test.webApp.Gus.repository.UserRepository;
import test.webApp.Gus.service.UserService;
import test.webApp.Gus.util.AuthUtils;
